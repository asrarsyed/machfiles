...
export PATH="$HOME/scripts:$PATH" # Add local scripts folder
...
export HOMEBREW_NO_AUTO_UPDATE=1                 # Skip auto updates (faster but riskier)
...
export HOMEBREW_BUNDLE_FILE=~/machfiles/brewfile # Default Brewfile path
